...
public class MusicController {
	...
	public MusicController() {
		...
		musicList.add(new MusicVO("Big Swing Band","1","../Test_Guess/musicList/BIG SWING BAND.mp3"));
		musicList.add(new MusicVO("Positive Happy","2","../Test_Guess/musicList/Positive Happy.mp3"));	
		musicList.add(new MusicVO("Puppe","3","../Test_Guess/musicList/Puppe.mp3"));	
	}
	...
	private void show() {    //private프라이빗 
		System.out.println("song: "+musicList.get(index).getTitle()
				+ "\n▶︎•၊၊||၊|။||||။၊|။•\r\n");
	}
	...
	public void search(String name) {   //search 매개변수 받기, 한글,영어,등
		for(int i=0; i<musicList.size(); i++) {
			...
			if(music.getTitle().equals(name)) {
				...
				System.out.println("정확한 노래 제목을 입력해 주세요!");
			}
		}
	}
