...
public class MusicController {
	...
	public MusicController() {
		...
		musicList.add(new MusicVO("Big Swing Band","1","../guessMovie/musicList/BIG SWING BAND.mp3"));
		musicList.add(new MusicVO("Positive Happy","2","../guessMovie/musicList/Positive Happy.mp3"));	
		musicList.add(new MusicVO("Puppe","3","../guessMovie/musicList/Puppe.mp3"));	
	}
